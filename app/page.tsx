  ...
  return (
    ...
    >
      ...
      <MorphingDialogContainer>
        ...
        <MorphingDialogClose
          className="fixed top-6 right-6 h-fit w-fit rounded-full bg-white p-1 cursor-pointer"
          variants={{
            initial: { opacity: 0 },
            animate: {
              opacity: 1,
              ...
              <MorphingDialogContainer>
                <MorphingDialogContent className="relative rounded-2xl bg-zinc-50 p-6 ring-1 ring-zinc-200/50 ring-inset dark:bg-zinc-950 dark:ring-zinc-800/50">
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-xl font-medium dark:text-zinc-100">{job.title}</h3>
                      <p className="text-zinc-500 dark:text-zinc-400">{job.company}</p>
                    </div>
                    <div>
                      <h4 className="mb-2 text-sm font-medium text-zinc-600 dark:text-zinc-400">Technologies</h4>
