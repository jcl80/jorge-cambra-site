...
A trap is not a gotcha. The chains that fail below contain no arithmetic errors and no absurd assumptions; they are what a reasonable estimator would write. The trap is what makes the question measure estimation rather than recall or luck, and a question without one measures neither.
