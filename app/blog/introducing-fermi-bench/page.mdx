...
```javascript
coal_kwh = to(93.9e9, 98.3e9)   // Fraunhofer ISE vs SMARD, 2025
solar_yield = to(150, 200)      // PVPro Solar, single-source range
germany_m2 = 357022e6           // Eurostat 
...
**Tiers.** Questions sit in one of three tiers, each sealing one more thing than the last.
...
The current bank holds 109 questions across 11 domains, evaluated on 40 models. The full leaderboard is at [fermibench.com](https://fermibench.com).
