**DRAFT** — This post is a work in progress. While the general results are mostly in line with what I believe are the final results, the math might be a bit off.
